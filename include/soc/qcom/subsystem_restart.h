...
extern int subsystem_restart_dev_asus(struct subsys_device *dev, int isReboot);
...
static inline int subsystem_restart_dev_asus(struct subsys_device *dev, int isReboot)
{
    return 0;
}

...
//<ASUS-BSP Robert_He 20170323> update touch firmware version ++++++
...
//<ASUS-BSP Robert_He 20170323> chip id is 582c which is different from driver 5446 +++++
        ...
        if ((uc_chip_id == FTS_582C_CHIP_ID1) &&
            ((uc_tp_vendor_id == FTS_VENDOR_1_ID)
             || (uc_tp_vendor_id == FTS_VENDOR_2_ID) || (uc_tp_vendor_id == FTS_VENDOR_3_ID))) {
...
//<ASUS-BSP Robert_He 20170328> update firmware while version is different +++++

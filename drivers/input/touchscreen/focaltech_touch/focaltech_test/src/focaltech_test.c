...
//<ASUS-BSP Robert_He 20170314> change filepath for factory test tool ++++++
// Define the configuration file storage directory
#define FTS_INI_FILE_PATH "/system/bin/"
#define FTS_RESULT_TOUCH_PATH "/data/data/"
//<ASUS-BSP Robert_He 20170314> change filepath for factory test tool ------
...
static int fts_test_entry(char *ini_file_name)
{
    ...
    printk("\n");
//<ASUS-BSP Robert_He 20170315> change filename for factory test tool ++++++
    fts_test_save_test_data("TouchSelfResult.csv", testdata, iTestDataLen);
    fts_test_save_test_data("TouchSelfResult.txt", TestResult, TestResultLen);
//<ASUS-BSP Robert_He 20170315> change filename for factory test tool ------
...
static ssize_t fts_test_show(struct device *dev, struct device_attribute *attr,
                             char *buf)
{
	//<ASUS-BSP Robert_He 20170314> show pass for factory test tool +++++

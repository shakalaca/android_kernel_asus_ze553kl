...
//<ASUS-BSP Robert_He 20170411> add gesture function  ++++++
...
//<ASUS-BSP Robert_He 20170411> add gesture function  ++++++
bool dclick_report_flag = false;
bool swipe_report_flag = false;
int gesture_detect = 0;
extern bool proximity_check_status(void);//disable gesture when psensor is close 20160425
//<ASUS-BSP Robert_He 20170411> add gesture function  ------
...
static void fts_check_gesture(struct input_dev *input_dev, int gesture_id)
{
    char *envp[2];
    int gesture;
	//<ASUS-BSP Robert_He 20170425>disable gesture when psensor is close ++++++
    ...
    {
//<ASUS-BSP Robert_He 20170411> add gesture function  ++++++
	ps_status = proximity_check_status();//disable gesture when psensor is close 20160425
	if (ps_status)
		return;

...
static unsigned char CTPM_FW_LIBRA_JTOUCH_TM[] = {
	#include "ASUS_LIBRA_3C47U_0x81_0x01_V0x10_20151120_app.cfg"
};
static unsigned char CTPM_FW_LIBRA_BIEL_CTC[] = {
	#include "ASUS_LIBRA_3C47U_0x39_0x01_V0x10_20151120_app.cfg"
};
static unsigned char CTPM_FW_LIBRA_GIS_TM[] = {
	#include "ASUS_LIBRA_3C47U_0x61_0x01_V0x11_20151120_app.cfg"
};
...
int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client)
{
	...
	switch(asus_project_id)
	{
		case ASUS_ZE553KL:
			...
			{
				case 2 : 
					CTPM_FW = CTPM_FW_LIBRA_BIEL_CTC;
					CTPM_FW_length = sizeof(CTPM_FW_LIBRA_BIEL_CTC);
					break;
				case 3 :
			    default:
					CTPM_FW = CTPM_FW_LIBRA_GIS_TM;
					CTPM_FW_length = sizeof(CTPM_FW_LIBRA_GIS_TM);
					break;
			}
			break;
		case ASUS_ZS550KL:
				printk("[Touch] : This is Aquairus!\n");
			break;
		case ASUS_ZD552KL:
			switch(asus_lcd_id)
			{
				...
				case 3 :
			    default:
					CTPM_FW = CTPM_FW_LIBRA_JTOUCH_TM;
					CTPM_FW_length = sizeof(CTPM_FW_LIBRA_JTOUCH_TM);
					break;
			}
			break;
		default:
			printk("[Touch] : NO this Project ID\n");
	}
